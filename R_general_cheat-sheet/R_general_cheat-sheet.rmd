...
Beispiele: Poisson oder Binomial?
• Anzahl Wahlberechtigter, die bei einer Umfrage unter 5000 Personen eine
Gesetzesvorlage befürworten.
• Anzahl Schadensfälle einer Versicherung.
• Anzahl Kunden, die einen Kredit beantragen.
• Anzahl Fahrzeuge, die bei einer Kontrolle von 100 angehaltenen Fahrzeugen
beanstandet werden müssen.

#examples: poisson vs binomial
#amount of eligible voters which are
